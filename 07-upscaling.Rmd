...
![Figure 8.1 QGIS Desktop with the browser panel on the upper left, the layer information on the bottom left and the display of your layers on the right.](images/Conv_upscaling1.png)
...
![Figure 8.2 Load the Macedonian Soil Map](images/Conv_upscaling2.png)
...
![Figure 8.3  Project properties and projection settings](images/Conv_upscaling3.png)
...
![Figure 8.4 Join attributes by location](images/Conv_upscaling4.png)
...
![Figure 8.5 Example field calculator](images/Conv_upscaling5.png)
...
![Figure 8.6 Calculate group statistics](images/Conv_upscaling6.png)
...
![Figure 8.7  Change the legend style to display the SOC values](images/Conv_upscaling7.png)
...
![Figure 8.8 Example of the Map composer](images/Conv_upscaling8.png)
...
![Figure 8.9 Change the projection of a raster file](images/Conv_upscaling9.png)
