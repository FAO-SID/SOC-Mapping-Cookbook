...
**Step 1 - Split data in into training ans testing subsets**
...
**Step 2 - Building a snsitivity map**

The validation plot shows the regression line between observed and predicted of a model that uses 75% (black line) and the regression lines of 10 model realizations, each with a different random combination of data for training and validating the models. 
...
**Step 3 - Analyzing the sensitivity of the map**

```{r, eval=FALSE, fig.cap='OCSKGM prediction based on 75% of data', echo=FALSE}
...
**Step 4 - Estimating the full conditional distribution of OCSKGMlog**
...
**Step 5 - Estimating the probability distribution function for each pixel**
...
**Step 6 - Saving the results as raster format**
