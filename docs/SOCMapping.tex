...
\begin{titlepage}
    \begin{center}
        ...
        \textbf{Soil Organic Carbon Mapping Cookbook\\}
        \vspace{0.5cm}
        \normalsize
        \emph{2nd edition}
        \vfill
...
Next method is called random forest \index{Random forest (RF)}. This one
...
\index{Prediction!model}. Whenever possible, DSM is recommended.
...
\textbackslash{}index\{Digital Soil Mapping (DSM)\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
...
\section{Diversity of national soil legacy data
...
\tightlist
\item
  \textbf{Dependent variable \(Y\)}: \index{dependent variable} What we
...
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\caption{\label{fig:predRK}Prediction FYROM map from regression-kriging
model}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-56-1.pdf}
\caption{\label{fig:unnamed-chunk-56}Model Decreasing Error and Node Purity
for the RF model}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-57-1.pdf}
\caption{\label{fig:unnamed-chunk-57}Select ntree}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-59}Sensitivity based on 10 realizations
using 25\% samples}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-62}OCSKGM quantregForest prediction}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-63}Total uncertainty}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-74}Performance of the different SVM models
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-76-1.pdf}
\caption{\label{fig:unnamed-chunk-76}SOC prediction map for FYROM using a
...
\caption{\label{tab:unnamed-chunk-82}Summary of map quality measures for three different mapping methods}
\centering
\begin{tabular}[t]{lrrrrrrrrr}
\toprule
  & RK & randomForest & svm\\
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-83-1.pdf}
\caption{\label{fig:unnamed-chunk-83}Scatter plots of predicted against
observed values}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{SOCMapping_files/figure-latex/unnamed-chunk-84-1} \caption{Spatial bubble of the prediction errors for RK}\label{fig:unnamed-chunk-84}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{SOCMapping_files/figure-latex/unnamed-chunk-85-1} \caption{Spatial bubble of the prediction errors for RF}\label{fig:unnamed-chunk-85}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{SOCMapping_files/figure-latex/unnamed-chunk-86-1} \caption{Spatial bubble of the prediction errors for SVM}\label{fig:unnamed-chunk-86}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-88}Statistical distribution of train and
test datasets}
\end{figure}
...
\citet{qiao2015no}; \citet{guevara_2018};
...
\caption{\label{fig:unnamed-chunk-92}Comparision of DSM model correlations
...
\caption{\label{fig:unnamed-chunk-93}Density plot of the prediction for
three DSM models}
\end{figure}
...
of the three models. The table containing these values was prepared in
...
\hypertarget{propagation-of-attribute-positional-and-covariate-uncertaintypropuncertainty}{%
\subsection{Propagation of attribute, positional and covariate
uncertainty\{propUncertainty\}}\label{propagation-of-attribute-positional-and-covariate-uncertaintypropuncertainty}}
...
\hypertarget{web-services-serving-soil-data-using-web-technologywebservice}{%
\section{Web services: serving soil data using web
technology\{webService\}}\label{web-services-serving-soil-data-using-web-technologywebservice}}
