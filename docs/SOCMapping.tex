...
\index{variance inflation factor}. There are several rules of thumb to
...
the sp \index{R Packages!sp} package we can define the columns in the
...
we can run a stepwise regression \index{stepwise variable selection}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{SOCMapping_files/figure-latex/unnamed-chunk-92-1} \caption{Spatial bubble of the prediction errors for SVM}\label{fig:unnamed-chunk-92}
\end{figure}

\textbf{Step 4 - Data-splitting} \{\#dataSplit\}
