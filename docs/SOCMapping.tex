...
\caption{An equal-area quadratic spline from Ponce-Hernandez et al. (1986) (Cited by Bishop et al., 1999)}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-17}Statistical distribution of original
...
\caption{\label{fig:unnamed-chunk-19}SRTM 90 m resampled to 1 km for FYROM}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-20}Soil map of FYROM}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-21}Rasterized soil map of FYROM from DEM
raster layer}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-24-1.pdf}
\caption{\label{fig:unnamed-chunk-24}Two different temperature layers
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-27-1.pdf}
\caption{\label{fig:unnamed-chunk-27}FYROM soil covariates}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-31-1.pdf}
\caption{\label{fig:unnamed-chunk-31}Soil map units and soil samples (in
...
\caption{\label{fig:unnamed-chunk-33}SOC prediction map for FYROM using
geo-matching}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-63}Sensitivity based on 10 realizations
using 25\% samples}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-65}OCSKGM prediction based on 75\% of
data}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-66}OCSKGM quantregForest prediction}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-67}Total uncertainty}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-78}Performance of the different SVM models
...
\caption{\label{fig:unnamed-chunk-80}SOC prediction map for FYROM using a
...
\caption{\label{tab:unnamed-chunk-86}Summary of map quality measures for three different mapping methods}
\centering
...
\begin{figure}
\centering
\includegraphics{SOCMapping_files/figure-latex/unnamed-chunk-87-1.pdf}
\caption{\label{fig:unnamed-chunk-87}Scatter plots of predicted against
observed values}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{SOCMapping_files/figure-latex/unnamed-chunk-88-1} \caption{Spatial bubble of the prediction errors for GM}\label{fig:unnamed-chunk-88}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-97}Comparision of DSM model correlations
...
\caption{\label{fig:unnamed-chunk-98}Density plot of the prediction for
three DSM models}
\end{figure}
