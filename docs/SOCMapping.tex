...
mapping (DSM; \citet{McBratney2003}). In the SCORPAN reference framework
...
formation \citep{Florinsky2012}. The SCORPAN (Soils, Climate, Organisms,
Parent material, Age and (N) space or spatial position, see
