...
The approaches in this technical manual consider the reference framework of the SCORPAN
model for digital soil mapping (DSM; \cite{McBratney2003}). In the
...
\citep{Florinsky2012}. The SCORPAN \textcolor{red}{(Soils, Climate,
Organisms, Parent material, Age and (N) space or spatial position, see
\cite{McBratney2003})} reference framework is a empirical approach
