...
|   |   |                                                                       | 
|---|---|-----------------------------------------------------------------------|
| Conventional upscaling  |  Class-matching | Derive average SOC stocks per "nclass": soil type for which a national map exists, or combination with other spatial covariates, e.g. land use category, climate type, biome, etc.This approach is used in the absence of spatial coordinates of the source data.  |
