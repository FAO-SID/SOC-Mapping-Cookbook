...
```{r, echo=T}
dat <- read.csv("examples/site-level.csv")
...
```{r, echo=FALSE}
dat <- read.csv("examples/profile-description.csv")
...
```{r, echo=FALSE}
dat <- read.csv("examples/soil-analytical.csv")
knitr::kable(dat, caption = "Example for soil analytical table")
```
