...
# See the summary of values produced using the pedo-transfer function with 
# one of the proposed methods.
summary(estimateBD(dat$SOC, method="Honeyset_Ratkowsky_1989"))

# Estimate BLD using the pedotransfer function:
dat$BLD <- estimateBD(dat$SOC, method="Grigal_1989")
