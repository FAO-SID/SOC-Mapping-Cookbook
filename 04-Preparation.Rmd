...
#### Estimate the Organic Carbon Stock using the virtual horizons

Finally, the estimation of the soil organic carbon stock can be done using the **GSIF** package.
