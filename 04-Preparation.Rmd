...
For organic soil material, BD can be estimated as follows, considering  the litter layer L (or Oi horizon); the organic or duff layer, which is partially decomposed material above the mineral soil and beneath the litter layer; F (fermentation); and H (humus) horizons (Oe and Oa), as described by the [*U.S. Soil Taxonomy*](https://www.nrcs.usda.gov/Internet/FSE_DOCUMENTS/nrcs142p2_051232.pdf).

**Forest floor**: Default values from @ottmar_litter_2007.

* Pine:  L 0.018 g/cm3 ,F/H 0.057 g/cm3

* Hardwood: L 0.012 g/cm3 [@barney_forest_1981]

* Birch: L/H 0.17 g/cm3

* Spruce: L 0.051 g/cm3, H 0.13 g/cm3

**Peat**: Default value: 0.31 g m^-3^. The range of peat BD is generally about 0.02 to 0.3 t m^3^ depending on maturity and compaction, as well as the ash content [@agus_measuring_2011].@batjes1996total and @agus_measuring_2011 distinguish different peat decomposition types (with different C content):

* Sapric 0.174 (48.90 % C)

* Hemic 0.117 (52.27% C)

* Fibric 0.089 (53.56 % C).

Examples for pedotransfer functions to estimate BD, based on the soil organic matter ($OM$) content in percent:
