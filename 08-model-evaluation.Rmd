...
```{r}
library(raster)
(RF<-raster('MKD_OCSKGM_rf.tif'))
(RK<-raster('MKD_OCSKGM_RK.tif'))
(SVM<-raster('MKD_OCSKGM_svm.tif'))
#Note that SVM has a different reference system 
SVM <- projectRaster(SVM, RF)
