...
```{r qgis, fig.cap="QGIS Desktop with the browser panel on the upper left, the layer information on the bottom left and the display of your layers on the right" , out.width='80%', echo=FALSE}
...
```{r qgisepsg, fig.cap="Project properties and projection settings" , out.width='80%'}
...
```{r, fig.cap="Join attributes by location" , out.width='80%', echo=FALSE}
...
```{r, fig.cap="Example field calculator" , out.width='80%', echo=FALSE}
...
```{r, fig.cap="Calculate group statistics" , out.width='80%', echo=FALSE}
...
```{r, fig.cap="Change the legend style to display the SOC values" , out.width='80%', echo=FALSE}
...
```{r, fig.cap="Example of the Map composer" , out.width='80%', echo=FALSE}
...
```{r, fig.cap="Change the projection of a raster file" , out.width='80%', echo=FALSE}
