# Preparation of Local Soil Property Data {#preparation}
*GF Olmedo & R Baritz*
...
This chapter includes two examples for data preparation. The first example is for using soil profiles data. This example is mixed with the text but a copy the code is presented in section \@ref(PreparationProfiles). The second example is using top soil or auger data and is presented in section \@ref(PreparationAuger).
