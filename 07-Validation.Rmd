...
knitr::kable(prederrors, caption = "Summary of prediction errors for 3 different mapping methods", digits = 2, align = "lll", booktabs = TRUE, format="latex") %>%
...
```{r}
knitr::kable(validation, caption = "Summary of map quality measures for 3 different mapping methods", digits = 3, align = "rlll", booktabs = TRUE, format="latex") %>%
             kable_styling(latex_options = "striped")
```
