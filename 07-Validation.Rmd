...
knitr::kable(prederrors, caption = "Summary of prediction errors for 3 different mapping methods", digits = 2, align = "lll")
```
...
knitr::kable(validation, caption = "Summary of map quality measures for 3 different mapping methods", digits = 3, align = "rlll")
```
