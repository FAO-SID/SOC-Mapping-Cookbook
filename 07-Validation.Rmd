...
```{r errormatrix2, fig.cap="Sample error matrix for a hypothetical soil class map" , out.width='80%', echo=FALSE}
...
**Table 7.1.** Map unit purity and class representation statistics for the hypothetical example given in Figure \@ref(fig:errormatrix2).
