...
\begin{equation}
M E A = |\underline{e}| = \frac{1}{N} \sum_{i=1}^{N} \underline{e} (s_i)
\end{equation}
...
\begin{equation}
A V E = 1 -  \frac{\sum_{i=1}^{N} (\hat{Z}(s_i) - Z(s_i))^2}{\sum_{i=1}^{N} \hfill (Z(s_i) - \underline{Z})^2 \hfill}
\end{equation}
...
\begin{equation}
\widehat{A V E} = 1 - \frac{\sum_{i=1}^{n} (\hat{Z}(s_i) - Z(s_i))^2}{ \sum_{i=1}^{n} \hfill (Z(s_i) -  \underline{\hat{Z}})^2 \hfill}
\end{equation}
