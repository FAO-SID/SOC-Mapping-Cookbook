...
**Estimation of quantitative map quality measures:** For each validation location we compute the error, e(si), the absolute error, |e|, or squared error, e2(si)2. The spatial mean of the mapping area for map quality measure x is then estimated by:
