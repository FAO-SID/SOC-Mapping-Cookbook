...
We present this diversity of methods because there is no *best* mapping method for digital soil mapping \index{Digital Soil Mapping (DSM)} and testing, and selection has to be done for every data scenario [@soil-2017-40].
