...
The standard depth for GSOCmap is **0cm to 30cm** [@gsp_guidelines_2017]. Subdivisions are possible depending on the available data, by genetic horizons or depth classes. The following depths are additionally considered for GSOCmap (optional):
