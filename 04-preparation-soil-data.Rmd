...
```{r grworkflow, fig.cap="An equal-area quadratic spline from Ponce-Hernandez et al. (1986)" (Cited by Bishop et al., 1999), out.width='80%', echo=FALSE, fig.align='center'}
