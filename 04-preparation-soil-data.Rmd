...
Examples for pedo-transfer functions to estimate $BD$, based on the soil organic matter ($SOM$) content in percent $(\%)$:
...
The standard depth for GSOCmap is **0 cm to 30 cm**. Subdivisions are possible depending on the available data, by genetic horizons or depth classes. The following depths are additionally considered for GSOCmap (optional):
