...
**Peat**: Default value: $BD_{P} = 0.31 g \cdot cm^{-3}$ @batjes1996. The range of peat BD is generally from 0.02 to 0.3$t \cdot m^{-3}$ depending on maturity and compaction, as well as the ash content [@agus_measuring_2011]. total and @agus_measuring_2011 distinguish different peat decomposition types with different C content:
