...
```{r, fig.cap="soil map of MK", eval=FALSE, fig.width=4}
...
# The rasterization process needs a layer with the target grd system: 
# spatial extent and cell size.
# The DEM raster layer could be used for this.
soilmap.r <- rasterize(x = soilmap, y = DEM, field = "Symbol")

plot(soilmap.r, col=rainbow(21))
legend("bottomright",legend = Symbol.levels, fill=rainbow(21), cex=0.5)
```
...
# Land cover is a categorical covariate, this has to be made explicit.
...
write.csv(dat, "data/MKD_RegMatrix.csv")
```
